<script lang="ts">
  ...
  import WeightEventsTable from "../../../events/components/WeightEventsTable.svelte";
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-muted-foreground text-sm mt-1 flex items-center gap-2">
            <span class="font-mono bg-muted/50 px-1.5 py-0.5 rounded text-[10px]">ID: {scale.scale_id}</span>
            <span class="text-muted-foreground/30">•</span>
            <span>Керування ваговою системою</span>
          </p>
        </div>
      </div>
    </div>
